"""
ThreatPulse SDK client for Python.
...
class ThreatPulse:
    """Batching client that ships events to the ThreatPulse ingest API."""
    ...
    def __init__(
        ...
        """
        Args:
            api_key:        API key (or set THREATPULSE_API_KEY env var).
            endpoint:       ThreatPulse base URL (or THREATPULSE_ENDPOINT env var).
            batch_size:     Auto-flush after this many queued events.
            flush_interval: Seconds between periodic flushes.
        """
        self.api_key = api_key or os.environ.get("THREATPULSE_API_KEY", "")
        self.endpoint = (
            endpoint
            or os.environ.get("THREATPULSE_ENDPOINT")
    ...
    def flush(self):
        ...
        try:
            ...
            print(f"[ThreatPulse] flush failed: {exc}")
